...
import com.vmg265.fastdrawplus.fork.categoryorder.CategoryComparator;
...
import com.vmg265.fastdrawplus.fork.views.NestedScrollChildManager;
...
public class Launcher {
    ...
    private synchronized void addItemsToCategory(@NonNull final String categoryName, final boolean immediate, @NonNull final LauncherItem... items) {
        if (hideHidden && categoryName.equals(com.vmg265.fastdrawplus.fork.Category.hiddenCategory)) {
            return;
        }
    ...
    private static String getDefaultCategory(@NonNull final LauncherItem item) {
        if (item instanceof ShortcutItem) {
            return com.vmg265.fastdrawplus.fork.Category.shortcutsCategory;
        } else {
            return com.vmg265.fastdrawplus.fork.Category.defaultCategory;
        }
    }
}
