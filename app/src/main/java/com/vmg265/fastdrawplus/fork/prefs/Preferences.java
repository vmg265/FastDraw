package com.vmg265.fastdrawplus.fork.prefs;
...
public final class Preferences {
    ...
    public final String globalIconPack;
    public final boolean hideAppTitles;
    public final float iconSizeMultiplier;
    ...
    public Preferences(@NonNull final Context context) {
        ...
        globalIconPack               = this.prefs.getString("globalIconPack", "");
        hideAppTitles                = this.prefs.getBoolean("hideAppTitles", false);
        iconSizeMultiplier           = Float.parseFloat(this.prefs.getString("iconSizeMultiplier", "1.0"));
    }
