package com.vmg265.fastdrawplus.fork.activities;

import static com.vmg265.fastdrawplus.fork.launcher.LaunchManager.PERMISSION_REQUEST_CODE;
...
import com.vmg265.fastdrawplus.fork.Category;
import com.vmg265.fastdrawplus.fork.R;
import com.vmg265.fastdrawplus.fork.RunnableQueue;
import com.vmg265.fastdrawplus.fork.SettableBoolean;
import com.vmg265.fastdrawplus.fork.Utils;
import com.vmg265.fastdrawplus.fork.WallpaperColorUtils;
import com.vmg265.fastdrawplus.fork.dialogs.ActionsSheet;
import com.vmg265.fastdrawplus.fork.dialogs.CategorySelectionDialog;
import com.vmg265.fastdrawplus.fork.dialogs.DialogUtils;
import com.vmg265.fastdrawplus.fork.launcher.AppItemManager;
import com.vmg265.fastdrawplus.fork.launcher.DropZone;
import com.vmg265.fastdrawplus.fork.launcher.LaunchManager;
import com.vmg265.fastdrawplus.fork.launcher.Launcher;
...
import com.vmg265.fastdrawplus.fork.launcher.launcheritem.AppItem;
import com.vmg265.fastdrawplus.fork.launcher.launcheritem.BitmapShortcutItem;
...
import com.vmg265.fastdrawplus.fork.launcher.launcheritem.OreoShortcutItem;
import com.vmg265.fastdrawplus.fork.launcher.launcheritem.ResShortcutItem;
import com.vmg265.fastdrawplus.fork.launcher.launcheritem.ShortcutItem;
import com.vmg265.fastdrawplus.fork.prefs.PrefMap;
import com.vmg265.fastdrawplus.fork.prefs.Preferences;
import com.vmg265.fastdrawplus.fork.receivers.InstallAppReceiver;
import com.vmg265.fastdrawplus.fork.prefs.DismissableSnackbars;
import com.vmg265.fastdrawplus.fork.views.CategoryTabLayout;
import com.vmg265.fastdrawplus.fork.views.Drawables;
import com.vmg265.fastdrawplus.fork.views.NestedScrollParent;
import com.vmg265.fastdrawplus.fork.views.animators.ViewElevationAnimator;
import com.vmg265.fastdrawplus.fork.views.gestures.Gesture;
import com.vmg265.fastdrawplus.fork.views.gestures.GestureMux;
import com.vmg265.fastdrawplus.fork.views.gestures.LongPress;
import com.vmg265.fastdrawplus.fork.views.gestures.Swipe;
import com.vmg265.fastdrawplus.fork.widgets.WidgetHolder;
import com.vmg265.fastdrawplus.fork.widgets.WidgetManager;
...
public class MainActivity extends AppCompatActivity implements CategorySelectionDialog.OnCategorySelectedListener {
    ...
    private void setupDropZones(final CategoryTabLayout tabContainer) {
        ...
        View editIconDropZone = findViewById(R.id.drop_zone_edit_icon);
        if (editIconDropZone != null) {
            editIconDropZone.setOnDragListener(new DropZone(
                (draggedItem) -> {
                    if (draggedItem instanceof AppItem) {
                        AppItem appItem = (AppItem) draggedItem;
                        com.vmg265.fastdrawplus.fork.dialogs.IconPickerBottomSheet dialog = com.vmg265.fastdrawplus.fork.dialogs.IconPickerBottomSheet.newInstance(appItem.getComponentName());
                        dialog.show(getSupportFragmentManager(), "IconPickerBottomSheet");
                    }
                },
                false
            ));
